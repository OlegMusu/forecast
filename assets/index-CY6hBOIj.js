...
`,Ei=`42e7f5eb5e92e38d5b0259217b9039e7`,Di=new hi.default.Icon({iconUrl:xi,shadowUrl:Si,iconSize:[25,41],iconAnchor:[12,41]});function Oi({city:e}){return(0,G.jsx)(Ci,{children:(0,G.jsxs)(`div`,{className:`container`,children:[(0,G.jsx)(wi,{children:`Weather map`}),(0,G.jsx)(Ti,{children:(0,G.jsxs)(_i,{center:[e.lat,e.lon],zoom:7,children:[(0,G.jsx)(K,{city:e}),(0,G.jsx)(bi,{url:`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`}),(0,G.jsx)(bi,{url:`https://tile.openweathermap.org/map/temp_new/{z}/{x}/{y}.png?appid=${Ei}`,opacity:.6}),(0,G.jsx)(bi,{url:`https://tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=${Ei}`,opacity:.35}),(0,G.jsx)(vi,{position:[e.lat,e.lon],icon:Di,children:(0,G.jsxs)(yi,{children:[e.name,(0,G.jsx)(`br`,{}),Math.round(e.weather.main.temp),`°C`]})})]})})]})})}function K({city:e}){let t=mi();return(0,v.useEffect)(()=>{t.flyTo([e.lat,e.lon],7)},[e.id]),null}var ki=W.section`
  margin: 80px auto;
...
`,Bi=e=>new Date(e.dt*1e3).toLocaleTimeString(`en-US`,{hour:`numeric`}),Vi=e=>new Date(e.dt*1e3).toLocaleTimeString(`en-US`,{hour:`numeric`,minute:`2-digit`});function Hi({city:e}){let[t,n]=(0,v.useState)(null),r=e?.forecast?.list?.slice(0,20)??[];if(!r.length)return null;let i=r.map(e=>Math.round(e.main.temp)),a=Math.floor(Math.min(...i)/5)*5,o=Math.ceil(Math.max(...i)/5)*5,s=i.map((e,t)=>({x:t/Math.max(r.length-1,1)*100,y:100-(e-a)/Math.max(o-a,1)*100})),c=Array.from({length:(o-a)/5+1},(e,t)=>o-t*5);return(0,G.jsx)(ki,{children:(0,G.jsx)(`div`,{className:`container`,children:(0,G.jsxs)(Ai,{children:[(0,G.jsx)(ji,{children:`Hourly forecast`}),(0,G.jsx)(Mi,{children:c.map(e=>(0,G.jsxs)(`span`,{children:[e,`°C`]},e))}),(0,G.jsxs)(Ni,{children:[(0,G.jsx)(Pi,{children:r.map(e=>(0,G.jsx)(`span`,{children:Bi(e)},e.dt))}),(0,G.jsxs)(Fi,{$cols:r.length,$rows:c.length-1,children:[(0,G.jsx)(Ii,{viewBox:`0 0 100 100`,preserveAspectRatio:`none`,children:(0,G.jsx)(Li,{points:s.map(({x:e,y:t})=>`${e},${t}`).join(` `)})}),s.map(({x:e,y:t},i)=>(0,G.jsx)(Ri,{$x:e,$y:t,onMouseEnter:()=>n(i),onMouseLeave:()=>n(null)},r[i].dt)),t!==null&&(0,G.jsxs)(zi,{$x:s[t].x,$y:s[t].y,children:[(0,G.jsx)(`strong`,{children:Vi(r[t])}),(0,G.jsxs)(`span`,{children:[i[t],`°C`]})]})]})]})]})})})}var Ui=W.section`
  padding: 0 20px;
...
`;function Zi({city:e}){let t=e.forecast?.list||[],n=[];return t.forEach(e=>{let t=e.dt_txt.split(` `)[0];n.some(e=>e.date===t)||n.push({date:t,item:e})}),(0,G.jsx)(Ui,{children:(0,G.jsxs)(`div`,{className:`container`,children:[(0,G.jsx)(Wi,{children:`forecast`}),(0,G.jsx)(Gi,{children:n.slice(0,7).map(({date:e,item:t})=>(0,G.jsxs)(Ki,{children:[(0,G.jsx)(qi,{children:new Date(t.dt*1e3).toLocaleDateString(`en-US`,{weekday:`short`,month:`short`,day:`numeric`})}),(0,G.jsx)(Ji,{src:`https://openweathermap.org/img/wn/${t.weather[0].icon}@2x.png`,alt:t.weather[0].description}),(0,G.jsxs)(Yi,{children:[Math.round(t.main.temp),`°C`]}),(0,G.jsx)(Xi,{children:t.weather[0].description})]},e))})]})})}var Qi=W.section`
  min-height: 595px;
  width: 100%;
...
`;function ca(){let[e,t]=(0,v.useState)(new Date),[n,r]=(0,v.useState)(()=>JSON.parse(localStorage.getItem(`weather-cities`)||`[]`)),[i,a]=(0,v.useState)(()=>JSON.parse(localStorage.getItem(`weather-cities`)||`[]`)[0]?.id||null),[o,s]=(0,v.useState)(``),[c,l]=(0,v.useState)([]),[u,d]=(0,v.useState)(``),[f,p]=(0,v.useState)(!1);(0,v.useEffect)(()=>{let e=setInterval(()=>t(new Date),1e3);return()=>clearInterval(e)},[]),(0,v.useEffect)(()=>{localStorage.setItem(`weather-cities`,JSON.stringify(n))},[n]);let m=n.find(e=>e.id===i),h=async(e,t,n={})=>{let[i,o]=await Promise.all([br(e,t),xr(e,t)]),s=`${e}-${t}`;r(r=>r.find(e=>e.id===s)?r.map(e=>e.id===s?{...e,weather:i,forecast:o}:e):[...r,{id:s,name:i.name||n.name,country:i.sys?.country||n.country||``,lat:e,lon:t,weather:i,forecast:o,saved:!1,image:``}]),a(s)},g=async e=>{try{p(!0),d(``);let t=await yr(e);if(!t.length)throw Error();let n=t[0];await h(n.lat,n.lon,n)}catch{d(`Город не найден`)}finally{p(!1)}},_=async e=>{e.preventDefault(),o.trim()&&(await g(o.trim()),s(``),l([]))},y=async e=>{let t=e.target.value;if(s(t),t.length<2){l([]);return}try{l(await yr(t))}catch{l([])}},b=async e=>{try{p(!0),await h(e.lat,e.lon,e),s(``),l([])}catch{d(`Не удалось загрузить город`)}finally{p(!1)}};return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(Qi,{children:(0,G.jsxs)($i,{className:`container`,children:[(0,G.jsx)(ea,{children:`Weather dashboard`}),(0,G.jsxs)(ta,{children:[(0,G.jsx)(`p`,{children:`Create your personal list of favorite cities and always be aware of the weather.`}),(0,G.jsx)(`span`,{}),(0,G.jsxs)(na,{children:[(0,G.jsx)(ra,{children:e.toLocaleDateString(`en-US`,{month:`long`,year:`numeric`})}),(0,G.jsxs)(ra,{children:[e.toLocaleDateString(`en-US`,{weekday:`long`}),`, `,e.getDate()]})]})]}),(0,G.jsxs)(ia,{onSubmit:_,children:[(0,G.jsx)(`input`,{value:o,onChange:y,placeholder:`Search location...`}),(0,G.jsx)(`button`,{type:`submit`,children:(0,G.jsx)(`img`,{src:pr,alt:`search`})})]}),c.length>0&&(0,G.jsx)(aa,{children:c.map(e=>(0,G.jsxs)(`button`,{onClick:()=>b(e),children:[e.name,e.state?`, ${e.state}`:``,`, `,e.country]},`${e.lat}-${e.lon}`))}),(0,G.jsx)(oa,{onClick:()=>{if(!navigator.geolocation){d(`Геолокация не поддерживается`);return}navigator.geolocation.getCurrentPosition(({coords:e})=>h(e.latitude,e.longitude).catch(()=>d(`Не удалось определить погоду`)),()=>d(`Разрешите доступ к геолокации`))},children:`My location`}),f&&(0,G.jsx)(`p`,{children:`Loading...`}),u&&(0,G.jsx)(sa,{children:u})]})}),(0,G.jsx)(Gr,{cities:n,selected:i,onSelect:a,onCitiesChange:r}),m&&(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(Oi,{city:m}),(0,G.jsx)(Hi,{city:m}),(0,G.jsx)(Zi,{city:m})]})]})}var la=W.h3`
  font-size: 20px;
  margin-top: 80px;
...
`,fa=`17359e3946544e06bf0a76d07975bc88`,pa=`https://herokuapp.com`,ma=`https://newsapi.org/v2/everything`,ha=async(e,t=1)=>{let n=`${ma}?apiKey=${fa}&q=${encodeURIComponent(e)}&page=${t}&pageSize=10`,r=await fetch(pa+n);if(!r.ok)throw Error(`Ошибка API: ${r.status}`);return r.json()},ga={query:`forecast`,news:[],loading:!1,page:1};function _a(e,t){switch(t.type){case`SET_NEWS`:return{...e,news:t.payload};case`SET_LOADING`:return{...e,loading:t.payload};case`NEXT_PAGE`:return{...e,page:e.page+1};default:return e}}function va(){let[e,t]=(0,v.useReducer)(_a,ga);return(0,v.useEffect)(()=>{async function n(){try{t({type:`SET_LOADING`,payload:!0});let n=(await ha(e.query,e.page)).articles.slice(0,4);t({type:`SET_NEWS`,payload:e.page===1?n:[...e.news,...n]})}catch(e){console.log(e)}finally{t({type:`SET_LOADING`,payload:!1})}}n()},[e.query,e.page]),(0,G.jsx)(G.Fragment,{children:(0,G.jsx)(`section`,{children:(0,G.jsxs)(`div`,{className:`container`,children:[(0,G.jsx)(la,{children:`News forecast`}),(0,G.jsx)(da,{children:e.news.map(e=>(0,G.jsxs)(`div`,{children:[(0,G.jsx)(`img`,{src:e.urlToImage||`/forecast/assets/no-pictures--eZbyHnr.png`}),(0,G.jsx)(`p`,{children:e.description})]},e.url))}),e.news.length>0&&!e.loading&&(0,G.jsx)(ua,{onClick:()=>{t({type:`NEXT_PAGE`})},children:`See more`})]})})})}var ya=W.section`
  padding-top: 40px;
  overflow: hidden;
  margin-bottom: 48px;
